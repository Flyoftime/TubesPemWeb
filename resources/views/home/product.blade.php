          ...
          <div class="row">
            ...
            <div class="col-md-6 col-xs-12 product-slider mb-60">
              ...
              <div class="flickity flickity-slider-wrap mfp-hover" id="gallery-main">
                ...
                <div class="gallery-cell">
                  <a href="/front/img/shop/item_lg_2.jpg" class="lightbox-img">
                    <img src="/front/img/shop/item_lg_2.jpg" alt="" />
                    <i class="ui-zoom zoom-icon"></i>
                  </a>
                </div>
                <div class="gallery-cell">
                  <a href="/front/img/shop/item_lg_3.jpg" class="lightbox-img">
                    <img src="/front/img/shop/item_lg_3.jpg" alt="" />
                    <i class="ui-zoom zoom-icon"></i>
                  </a>
                </div>
                <div class="gallery-cell">
                  <a href="/front/img/shop/item_lg_4.jpg" class="lightbox-img">
                    <img src="/front/img/shop/item_lg_4.jpg" alt="" />
                    <i class="ui-zoom zoom-icon"></i>
                  </a>
                </div>
                <div class="gallery-cell">
                  <a href="/front/img/shop/item_lg_5.jpg" class="lightbox-img">
