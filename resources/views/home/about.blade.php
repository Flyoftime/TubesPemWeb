            ...
            <div class="col-sm-3 col-xs-6 col-xxs-12 mb-40">
                <div class="team-wrap">
                    <div class="team-member">
                        ...
                        <div class="team-details text-center">
                            <h4 class="team-title">Shafira</h4>
            ...
            <div class="col-sm-3 col-xs-6 col-xxs-12 mb-40">
                <div class="team-wrap">
                    <div class="team-member">
                        ...
                        <div class="team-details text-center">
                            <h4 class="team-title">Crystal</h4>
...
<section class="section-wrap testimonials">
    <div class="container">
        ...
        <div id="owl-testimonials" class="owl-carousel owl-theme owl-dark-dots text-center">
            ...
            <div class="item">
                <div class="testimonial">
                    <p class="testimonial-text">This is the excellent theme. It has many useful features that can be use
                        for any kind of business. The support is just amazing and design</p>
